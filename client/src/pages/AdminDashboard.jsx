...
const AdminDashboard = () => {
  ...
  const fetchAllData = async () => {
    try {
      ...
      if (Array.isArray(revRes.data?.data)) {
      ...
      if (Array.isArray(paymentRes.data?.data)) {
    ...
    <div style={styles.container}>
      ...
      <div style={styles.summaryGrid}>
        ...
        <div style={styles.card}>
          ...
          <p style={styles.cardValue}>
            ${(dashboardData?.totalRefunds || 0).toFixed(2)}
          </p>
          <p style={styles.cardSubtext}>
            {dashboardData?.refundCount || 0} transactions
          </p>
        </div>
        ...
        <div style={styles.chartCard}>
          ...
          <div style={styles.metricsTable}>
            <div style={styles.metricRow}>
              <span style={styles.metricLabel}>Average Order Value:</span>
              <span style={styles.metricValue}>
                ${(dashboardData?.averageOrderValue || 0).toFixed(2)}
              </span>
            </div>
            <div style={styles.metricRow}>
              <span style={styles.metricLabel}>Completed Orders:</span>
              <span style={styles.metricValue}>
            ...
            <div style={styles.metricRow}>
              <span style={styles.metricLabel}>Refund Rate:</span>
              <span style={styles.metricValue}>
                {dashboardData?.refundRate || 0}%
              </span>
            </div>
          </div>
        </div>
